...
const lang = i18n.language
  ...
  return (
    <>
      <div className="flex items-center justify-center w-full h-[350px] xl:h-[200px] p-8 bg-gradient-to-b from-[#28154d] to-[#6011ff] text-white text-center rounded rounded-bl-[100px] rounded-br-[100px] lg:rounded-br-[0px] shadow-2xl -z-50">
