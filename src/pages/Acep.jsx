        ...
        <div className="flex justify-between items-center py-4">
          <div className="w-full xl:w-[50%]">
            ...
            <div className="w-full mt-8 ">
              <div className="xl:absolute 2xl:left-[740px] 2xl:top-[300px] xl:left-[580px] xl:top-[450px] top-[353px] left-[470px] xl:w-[17%] w-full">
              ...
              <div className="xl:absolute 2xl:left-[1220px] 2xl:top-[30px] xl:left-[950px] xl:top-[50px] top-[10px] left-[800px] xl:w-[17%] w-full">
              ...
              <div className=" xl:absolute 2xl:left-[1210px] 2xl:top-[499px] xl:left-[980px] xl:top-[470px] top-[470px] left-[800px] xl:w-[17%] w-full">
